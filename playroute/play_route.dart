...
//     print("$vid/$starteddateselected/$enddateselected");

//     if (response.statusCode == 200) {
//       var extractedData = json.decode(response.body);

//       print("thisiscrash $extractedData");
//       showmessage = true;
//       setState(() {
//         if (extractedData["historyData"] != []) {
...
//         if (pointofstopped.length != null) {
//           for (int i = 0; i < pointofstopped.length; i++) {
//             String str = "${stoppagepoints[0]["haltedDuration"]}";

//             // healted to

//             String date = stoppagepoints[0]["haltedFromDate"];
...
//             String date2 = stoppagepoints[0]["haltedToDate"];
...
//                     position: pointofstopped[0],
//                     infoWindow: InfoWindow(
//                         title:
//                             "Stop Time:$timePart km: ${stoppagepoints[0]["kMsTravelled"]}km",
//                         snippet:
//                             " From: $formattedDate  Till: $formattedDate2")),
//                 child: _customMarker2('0', Colors.red),
//               ),
//             );
//           }
//         } else {
...
//                                   child: const Center(
//                                     child: Text(
//                                       "TODAY NO MOVING DATA AVAILABLE ",
...
//     } else {
//       _markerLocation = LatLng(0.0, 0.0);
//       _marker = Marker(
//         markerId: const MarkerId('marker'),
//         position: _markerLocation!,
//         rotation: 2.0,
