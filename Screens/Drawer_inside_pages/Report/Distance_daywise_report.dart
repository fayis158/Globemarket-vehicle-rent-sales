...
class Distance_daywise_report extends StatefulWidget {
  @override
  State<Distance_daywise_report> createState() =>
      _Distance_daywise_reportState();
}

class _Distance_daywise_reportState extends State<Distance_daywise_report> {
  // const Distance_daywise_report({super.key});
  bool hideshow = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          distancedaywisereportlist.isNotEmpty?   IconButton(onPressed: () {
              final formattedDate =
                        DateFormat('yyyy-MM-dd HH:mm:ss').format(datetime);
                    final formattedDate2 =
                        DateFormat('yyyy-MM-dd HH:mm:ss').format(datetime2);

              Api.emailsenddocument(selectedVId, "6", formattedDate,
                        formattedDate2, "0");
              ...
              children: [
                      ...
                      Row(
                        children: [
                           MaterialButton(
                            onPressed: () {
                              setState(() {
                                distancedaywisereportlist.clear();
                              });
                ...
                Expanded(
                  child:ListView.builder(
                    itemCount: distancedaywisereportlist.length,
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            Daywise(
                              vehiclenum: distancedaywisereportlist[index]
                                  ["vehicleNo"],
                              date: distancedaywisereportlist[index]
                                  ["reportDate"],
                              distanceinkm: distancedaywisereportlist[index]
                                  ["distance_km"],
                              totdistanceinkm: distancedaywisereportlist[index]
                                  ["cumulativeTotal_km"],
                            )
                          ],
                        ),
